    ...
    def _show_dashboard(self, display_page):
        ...
        try:
            with canvas(self.device) as draw:
                if not display_page == OledDisplayEnum.BANNER:
                    draw.text((1, 1), text=self.config.get_application_name(), font=font_header, fill='white')
                    ...
                    elif display_page == OledDisplayEnum.ACTIVE:
